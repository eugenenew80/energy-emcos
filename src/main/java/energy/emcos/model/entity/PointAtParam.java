...
@NoArgsConstructor
@Entity
@Table(name = "emcos_at_point_params")
@IdClass(PointAtParamId.class)
@DynamicUpdate
public class PointAtParam implements Serializable {
    public PointAtParam(@NotNull String pointCode, @NotNull String paramCode) {
